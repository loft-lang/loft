...
**Every sub-arc shipped (A1–A3, B1–B3, C1), plus B4 — the hot spots A3 attributed, cut by 35 % of a compile's instructions.** What follows under *Why now* is the state at filing. loft's
