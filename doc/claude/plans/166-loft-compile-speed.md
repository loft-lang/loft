...
**Active — A1, A2 and C1 shipped; A3 needs the engine profile grouped by module; B1 (found by A2) and B2 are next, behind the C1 gate.** What follows under *Why now* is the state at filing. loft's
