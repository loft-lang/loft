...
`LOFT_NO_LEASE_REFUSE=1` is the drop gate's switch-off and the bisect step.  P4 is DONE
(2026-09-24): `OpCopy` runs at every copy a leasing type makes, the view-lowered ones
materialised (`formal/heap.md` D-heap-9 closed).  Next: P5, the removals.  Tracked as
