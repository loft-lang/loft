...
|---|---|---|---|
| **P0** — the pass runs from this tree; baseline table lands in PERFORMANCE.md | [DESIGN.md § P0](DESIGN.md) | any of the 14 hashes moves; any ratio grows vs the issue's baseline | Open |
