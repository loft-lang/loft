...
recorded on @I78) included — § Decisions taken.**  The design is
...
- **Last touched:** 2026-09-15 (FINISHED: D-disp-1 and D-disp-2 closed, OPEN: 0; Q4 answered; Q5 done as @F122 + @I78)
...
- **Q5 (reserve `@F` tags for the construct and for `Disp-World`)** — done 2026-09-15: the
  ...
  `Disp-World` is a section of **@I78** (*Live-reload dispatch*), the mechanism it extends,
