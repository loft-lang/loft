...
**OPEN: 1.**  `D-Null-Field` (loft#1450's `(N-Prop)` leg, opened 2026-09-08): a field read
through a nullable receiver types non-null.  The fix is written and was reverted on migration
cost — 16 files across fixtures, integration programs and tools — and the register carries the
measurement.  Deferred, not declined.  `D-Null-Recv`, `D-Null-Guard` and `D-Null-Place` opened and closed 2026-09-07
