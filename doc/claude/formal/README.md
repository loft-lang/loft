...
collections.md 1, coroutines.md 1 and performance.md 1 (`rule_tags.py registers`, re-measured
on the joined tree 2026-09-22). Every other chapter is at 0, and each zero is a claim to re-measure against the
