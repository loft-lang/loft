...
**Eleven deviations are open, in six chapters:** heap.md 4, operational.md 2, binding.md 2,
collections.md 1, performance.md 1 and tuples.md 1 (`rule_tags.py registers`, re-measured
2026-09-22, after coroutines.md's `D-cor-3` closed and tuples.md's `D-tup-15` opened). Every other chapter is at 0, and each zero is a claim to re-measure against the
